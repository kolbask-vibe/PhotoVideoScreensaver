...
OutputBaseFilename=PhotoVideoScreensaver_2.5.6_setup
Compression=lzma2
...
[UninstallRun]
Filename: "{app}\PhotoVideoScreensaver.exe"; Parameters: "/uninstall"; Flags: runhidden; RunOnceId: "ClearAllUserRegistrySettings"
